...
TEST_FUNC constexpr void test()
{
  ...
  constexpr T values[] = {
    ...
    T{1},
#if _CCCL_HAS_INT128()
    T(0xb3b3'b3b3'b3b3'b3b3'b3b3'b3b3'b3b3'b3b3_u128),
    T(0x7b1a'7b1a'7b1a'7b1a'7b1a'7b1a'7b1a'7b1a_u128),
#else // ^^^ _CCCL_HAS_INT128() ^^^ / vvv !_CCCL_HAS_INT128() vvv
    T(0xb3b3'b3b3'b3b3'b3b3),
    T(0x7b1a'7b1a'7b1a'7b1a),
  ...
  constexpr T masks[] = {
    ...
    T{1},
#if _CCCL_HAS_INT128()
    T(0x5555'5555'5555'5555'5555'5555'5555'5555_u128),
    T(0xaaaa'aaaa'aaaa'aaaa'aaaa'aaaa'aaaa'aaaa_u128),
#else // ^^^ _CCCL_HAS_INT128() ^^^ / vvv !_CCCL_HAS_INT128() vvv
    T(0x5555'5555'5555'5555),
    T(0xaaaa'aaaa'aaaa'aaaa),
#endif // ^^^ !_CCCL_HAS_INT128() ^^^
    high_bit,
    low_half,
    high_half,
